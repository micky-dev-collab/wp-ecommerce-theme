                ...
                <div class="col-md-12">
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <?php
                            // get terms , loop and render categories
                ...
                ">
                            <div class="banner-content p-5">
                                <div class="content-wrapper text-light">
                                    ...
                                    <a href="<?php echo home_url('/') ?>?discount=20" class="btn-link text-white">Shop Now</a>
